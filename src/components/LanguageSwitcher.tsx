...
function loadTranslations(lang: string): Record<string, any> {
  ...
  categories.forEach(category => {
    try {
      ...
      // The path resolution depends on your bundler configuration.
      // Using require here for synchronous import.
...
// For large projects with 110 languages, consider lazy-loading per language.
